export const pricingSchemas = {
  ...
  EstimateFareRequest: {
    ...
    properties: {
      ...
      isNight: {
        ...
        example: false,
        description:
          "Optional. If omitted, automatically determined based on current server time.",
      },
      emergencySeverity: {
        type: "string",
  ...
  FareEstimateResponse: {
    ...
    properties: {
      ...
      message: { type: "string", example: "Estimated fare calculated successfully" },
      data: {
        type: "object",
        properties: {
          ambulanceType: { type: "string", example: "ICU" },
          distanceKm: { type: "number", example: 14.5 },
          estimatedDurationMins: { type: "number", example: 35 },
          baseFare: { type: "number", example: 1500.0 },
          distanceFare: { type: "number", example: 870.0 },
          durationFare: { type: "number", example: 175.0 },
          subtotal: { type: "number", example: 2545.0 },
          nightSurgeMultiplier: { type: "number", example: 1.0 },
          emergencySurgeMultiplier: { type: "number", example: 1.2 },
          totalSurgeMultiplier: { type: "number", example: 1.2 },
          calculatedFare: { type: "number", example: 3054.0 },
          minFare: { type: "number", example: 2000.0 },
          finalEstimatedFare: { type: "number", example: 3054.0 },
          currency: { type: "string", example: "BDT" },
          platformCommissionRate: { type: "number", example: 0.12 },
          estimatedCommission: { type: "number", example: 366.48 },
          estimatedDriverNet: { type: "number", example: 2687.52 },
        },
      },
    },
  },
